...
<html lang="en">
    <head>
        ...
        <title>Segunda Página del Catálogo</title>
  ...
  <a href="?pagina=pagina1"><button class="boton">Anterior</button></a>
    <a href="?pagina=pagina3"><button class="boton">Siguiente</button></a>
    ...
    public function display() {
        ...
        $productos = $mis_productos->vuelcoProductos(2); //Le indico la página para que filtre los productos
