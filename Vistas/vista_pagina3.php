...
<html lang="en">
    <head>
        ...
        <title>Tercera Página del Catálogo</title>
  ...
  <a href="?pagina=pagina2"><button class="boton">Anterior</button></a>
    ...
    public function display() {
        ...
        $productos = $mis_productos->vuelcoProductos(3); //Le indico la página para que filtre los productos
